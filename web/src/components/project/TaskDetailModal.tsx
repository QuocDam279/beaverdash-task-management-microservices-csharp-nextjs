...
export function TaskDetailModal({
  ...
  return (
    <div 
      onClick={onClose}
      className="fixed inset-0 bg-[#091e42]/50 dark:bg-black/60 backdrop-blur-xs flex items-center justify-center z-50 p-4 select-none animate-in fade-in duration-200"
    >
      <div 
        onClick={(e) => e.stopPropagation()}
        className="relative bg-white dark:bg-[#161a1d] rounded-lg border border-slate-200 dark:border-[#2c3338] shadow-2xl w-full max-w-4xl h-[85vh] flex flex-col animate-in zoom-in-95 duration-200 overflow-hidden"
      >
        <TaskDetailHeader 
          onClose={onClose} 
