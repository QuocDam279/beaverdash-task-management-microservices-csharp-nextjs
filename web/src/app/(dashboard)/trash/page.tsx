    ...
    return (
      <div className="min-h-full flex items-center justify-center p-8 bg-white select-none">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-xs font-semibold text-slate-500 font-sans">Đang tải thùng rác...</span>
        </div>
      </div>
    );
  }
    ...
    <div className="flex flex-col h-full w-full bg-white select-none p-6 md:p-8 font-sans">
      ...
      <div className="mb-6 pb-4 border-b border-slate-100 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight text-[#292a2e]">Thùng rác công việc</h1>
        ...
        {filteredTasks.length > 0 && (
          <button
            ...
            className="px-3.5 py-1.5 text-xs font-bold text-slate-500 hover:text-red-600 bg-white hover:bg-red-50 border border-slate-200 hover:border-red-200 rounded transition-all duration-200 flex items-center gap-1.5 cursor-pointer"
      ...
      {error ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center py-16 text-center border-2 border-dashed border-slate-200/60 rounded-xl m-4 bg-slate-50/50">
          ...
          <h3 className="text-xs font-bold text-slate-500 uppercase tracking-wide">Thùng rác trống</h3>
